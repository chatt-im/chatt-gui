...
typedef enum HsvColorWheelInputIndex {
  HsvColorWheelInputIndex_Wheels = 1,
  HsvColorWheelInputIndex_ViewportSize = 2,
} HsvColorWheelInputIndex;
 ...
 */
typedef struct HsvColorWheelGeometry HsvColorWheelGeometry;
